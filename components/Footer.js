      ...
      <div className='w-1/2 bg-gray-50'>
        <form className='flex flex-wrap justify-between' action="">
          ...
          <div className='mt-4'style={{width:'49%'}}>
            <input className='w-full p-4 rounded-2xl bg-gray-100 text-lg' type="email" placeholder='Email' required={true}/>
          </div>
          <div className='mt-4' style={{width:'49%'}}>
            <input className='w-full p-4 rounded-2xl bg-gray-100 text-lg' type="text" placeholder='How did you find me?' required={true}/>
          </div>
          <div className='w-full mt-4'>
            <textarea className='w-full p-4 rounded-2xl bg-gray-100 text-lg' name="message" id="message" placeholder='How can I assist?' rows="5" required={true}/>
          </div>
          <div>
            <input type="submit"/>
          </div>
